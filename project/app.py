...
# ---------- Google Translate виджет (в sidebar) ----------
# Размещаем в боковой панели, чтобы не мешал основному контенту
with st.sidebar:
    st.markdown("### 🌐 Translate / Перевести")
    translate_html = """
    ...
    """
    components.html(translate_html, height=100)
